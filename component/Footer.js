...
{   
    ...
    <footer class="footer">
        ...
        <ul class="filters">
            ${Object.keys(filters).map(key_filter => html`
                <li>
                    <a class="${filter === key_filter && "selected"}" href="#"
                    onclick="dispatch('switchFilter', '${key_filter}')">
                    ${key_filter[0].toUpperCase() + key_filter.slice(1)}
                    </a>
                </li>
            `
            )}
